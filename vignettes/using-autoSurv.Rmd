...
author: "Krithika Suresh, Cameron Severn, Debashis Ghosh"
date: "Dec 20, 2021"
...
pbc.testid <- ggplot(data = subset(pred_probs_mat, model%in%c("cox","rsf","glm","nnet")), 
                     aes(y = probs, x = times, color = model)) +
  geom_step(size=0.8) +
